  ...
  services.llama-swap = {
    ...
    settings = {
      ...
      models = {
        ...
        "gemma-4-nt:26b" = {
          cmd = "${llama-server} -dev ROCm0 -hf unsloth/gemma-4-26B-A4B-it-GGUF:UD-Q4_K_S --port \${PORT} --n-gpu-layers 999 --repeat-penalty 1.0 --reasoning off --spec-type draft-mtp --spec-draft-n-max 2";
        };
        "qwen3.6:27b" = {
