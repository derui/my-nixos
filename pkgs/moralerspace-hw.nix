...
stdenvNoCC.mkDerivation {
  ...
  src = fetchzip {
    url = "https://github.com/yuru7/moralerspace/releases/download/v1.0.2/MoralerspaceHW_v1.1.0.zip";
    hash = sha256;
    stripRoot = true;
  };

  installPhase = ''
    install -m444 -Dt $out/share/fonts/truetype/moralerspace-hw *.ttf
  '';
